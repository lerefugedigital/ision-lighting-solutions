...
export const alt = "Automotive machine vision lighting guide — Vision Lighting Solutions";
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              Coaxial · Dome · vision-lighting-solutions.com
            </div>
          </div>

          {/* Brushed-metal panel with a weld-seam line and rivets */}
          <div
            style={{
              position: "relative",
              display: "flex",
              ...
              backgroundImage: "linear-gradient(180deg, #334155 0%, #1e293b 100%)",
              flexShrink: 0,
            }}
          >
            <div

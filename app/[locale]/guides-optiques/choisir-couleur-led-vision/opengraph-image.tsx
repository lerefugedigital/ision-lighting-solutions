...
export const alt = "Choosing LED color for machine vision — Vision Lighting Solutions";
...
const COLORS = ["#f8fafc", "#dc2626", "#2563eb", "#7c3aed"];
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              White · Red · Blue · IR · vision-lighting-solutions.com
            </div>
          </div>

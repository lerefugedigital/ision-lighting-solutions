...
export const alt = "Polarized lighting to eliminate glare — Vision Lighting Solutions";
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              Crossed Polarizers · vision-lighting-solutions.com
            </div>
          </div>

          {/* Two crossed polarizing filters: horizontal axis vs vertical axis */}
          <div style={{ display: "flex", gap: 24, flexShrink: 0 }}>
            ...
            >
              <div style={{ display: "flex", width: 90, height: 6, borderRadius: 999, backgroundColor: "#fbbf24" }} />
            </div>
            <div
              style={{
                position: "relative",
            ...
            >
              <div style={{ display: "flex", width: 6, height: 90, borderRadius: 999, backgroundColor: "#fbbf24" }} />
            </div>
          </div>
        </div>

...
export const alt = "UV lighting and fluorescence detection guide — Vision Lighting Solutions";
    ...
    (
      <div
        style={{
          ...
          backgroundImage: "linear-gradient(135deg, #1e1b4b 0%, #020617 65%)",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              365-405nm · vision-lighting-solutions.com
            </div>
          </div>

          {/* UV excitation -> visible fluorescence emission visualization */}
          <div style={{ display: "flex", alignItems: "center", gap: 24, flexShrink: 0 }}>
            ...
            />
            <div style={{ display: "flex", width: 40, height: 4, backgroundColor: "#475569" }} />
            <div
              style={{
                display: "flex",
                width: 130,

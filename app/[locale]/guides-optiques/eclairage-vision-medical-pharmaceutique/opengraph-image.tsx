...
export const alt = "Medical and pharmaceutical machine vision lighting guide — Vision Lighting Solutions";
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 42, fontWeight: 800, lineHeight: 1.15 }}>
              {title}
            </div>
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              Backlight · Dome · vision-lighting-solutions.com
            </div>
          </div>

          {/* Medical cross made of two overlapping rectangles */}
          <div style={{ position: "relative", display: "flex", width: 180, height: 180, flexShrink: 0 }}>
            <div
              style={{
                position: "absolute",
                left: 65,

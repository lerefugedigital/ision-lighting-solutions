...
export const alt = "IP69K stainless steel lighting for the food industry — Vision Lighting Solutions";
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              316L Stainless · vision-lighting-solutions.com
            </div>
          </div>
          ...
          >
            <div style={{ display: "flex", fontSize: 42, fontWeight: 800, color: "#fbbf24" }}>IP69K</div>
            <div style={{ display: "flex", marginTop: 8, fontSize: 18, color: "#94a3b8" }}>ISO 20653</div>
          </div>
        </div>

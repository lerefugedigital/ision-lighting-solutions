...
/** Have their own dedicated routes — excluded here to avoid a route conflict. */
const DEDICATED_SLUGS = [
  "eclairage-infrarouge-industriel",
  "eclairage-ultraviolet-uv",
  "choisir-couleur-led-vision",
  "eclairage-inox-ip69k-agroalimentaire",
  "vision-industrielle-automobile",
  "eclairage-vision-medical-pharmaceutique",

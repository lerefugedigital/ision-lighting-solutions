...
export const alt = "Brightfield vs darkfield lighting comparison — Vision Lighting Solutions";
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              Domes · Bar Lights · vision-lighting-solutions.com
            </div>
          </div>

          {/* Split comparison: bright field with dark defect vs dark field with bright defect */}
          <div style={{ display: "flex", flexShrink: 0, borderRadius: 12, overflow: "hidden", border: "1px solid #334155" }}>
            <div
              style={{
                display: "flex",
                width: 130,
            ...
            >
              <div style={{ display: "flex", width: 14, height: 60, borderRadius: 999, backgroundColor: "#0f172a" }} />
            </div>
            <div
              style={{
                display: "flex",
            ...
            >
              <div style={{ display: "flex", width: 14, height: 60, borderRadius: 999, backgroundColor: "#fbbf24" }} />
            </div>
          </div>
        </div>

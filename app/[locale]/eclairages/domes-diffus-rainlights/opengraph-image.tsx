...
export const alt = "Diffuse dome lights for machine vision — Vision Lighting Solutions";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          ...
          {/* Dome visualization: glowing hemisphere with an open center */}
          <div
            style={{
              display: "flex",
              width: 260,
              height: 260,
              borderRadius: 999,
              backgroundImage: "linear-gradient(180deg, #fef3c7 0%, #d97706 100%)",
              alignItems: "center",
              justifyContent: "center",
              flexShrink: 0,
            }}

...
export const alt = "LED backlights for machine vision — Vision Lighting Solutions";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          ...
          {/* Backlight panel visualization: glowing rectangle with a dark silhouette shape on top */}
          <div
            style={{
              position: "relative",
              display: "flex",

...
export const alt = "Coaxial lighting for machine vision — Vision Lighting Solutions";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          ...
          {/* Coaxial housing visualization: box with a beamsplitter stripe and an on-axis output */}
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0, flexShrink: 0 }}>
            ...
            >
              <div style={{ display: "flex", flex: 1, backgroundColor: "#1e293b" }} />
              <div style={{ display: "flex", height: 6, backgroundColor: "#fbbf24" }} />
              <div style={{ display: "flex", flex: 1, backgroundColor: "#0f172a" }} />
            </div>
            <div style={{ display: "flex", width: 4, height: 40, backgroundColor: "#d97706" }} />
            <div
              style={{
                display: "flex",
                width: 36,

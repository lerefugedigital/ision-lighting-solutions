...
export const alt = "PNP/NPN signal converter — Vision Lighting Solutions";
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              Sourcing / Sinking · vision-lighting-solutions.com
            </div>
          </div>

          {/* PNP <-> NPN block diagram */}
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", flexShrink: 0, gap: 18 }}>
            <div
              style={{
                display: "flex",
                width: 170,

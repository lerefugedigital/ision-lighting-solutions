...
export const alt = "Cognex camera compatibility — Vision Lighting Solutions";
...
const SERIES_LABELS = ["In-Sight 2000", "In-Sight 7000", "In-Sight 8000/9000", "DataMan 470/475"];
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 48 }}>
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 620 }}>
            ...
            <div style={{ display: "flex", marginTop: 24, fontSize: 24, color: "#94a3b8" }}>
              Cognex In-Sight &amp; DataMan · vision-lighting-solutions.com
            </div>
          </div>
